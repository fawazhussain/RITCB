	...
	<div id="body">
		<div id="info">
			...
			try {
				...
				out.println("<br><form action=\"Details\" method=\"get\">Your Name : <input type=\"text\" name=\"name\"><br><br>Mobile Number : <input type=\"text\" name=\"num\"><br><br><input type=\"hidden\" name=\"table\" value=\""+table+"\" ><input type=\"hidden\" name=\"tt\" value=\""+tt+"\" ><input type=\"submit\" value=\"Place order\" onclick=\"alert('ORDER PLACED!!')\"></form>");
